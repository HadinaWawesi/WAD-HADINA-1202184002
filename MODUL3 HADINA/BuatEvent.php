...
if(isset($_POST["submit"])){
  ...
  //query insert data
  $query = "INSERT INTO event_table VALUES ('','$name','$deskripsi','$gambar','$kategori','$tanggal','$mulai','$berakhir','$tempat','$harga','$benefit')";
...
<form action="" mehtod="POST" name="submit">
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
      ...
      <input name="deskripsi" type="text" class="form-control" id="formGroupExampleInput2" placeholder="Deskripsi">
      </div>
      <div class="form-group">
...
<form action="" mehtod="POST" name="submit">
  <div class="col-sm-6">
    <div class="card">
      ...
      <input name="tanggal" type="date" class="form-control" id="tanggal" placeholder="dd/mm/yyyy">
      </div>
      <div class="form-group">
      ...
      <input name="tempat" type="text" class="form-control" id="tempat" placeholder="">
      </div>
      <div class="form-group">
      ...
      <div class="form-check form-check-inline">
       ...
       <button type="button" class="btn btn-danger"><a href="Home.php"></a> Cancel</button>
       </div>
    </div>
  </div>
</div>
